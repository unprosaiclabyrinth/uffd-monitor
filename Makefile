...
libuffd.so: uffd.c vma.c fork.c cache.c log.c sigchld.c spy.c clean test
	$(CC) $(CFLAGS) $(CFLAGS_COMPEL) $(shell $(COMPEL) includes) $< vma.c fork.c cache.c log.c sigchld.c -o $@ spy.c $(shell $(COMPEL) --static libs)
