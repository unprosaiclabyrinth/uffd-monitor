...
run1: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t01

run2: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t02

run3: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t03

run4: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t04
...
run6: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t06/t06

run7: libuffd.so
	sudo UFFD_MONITOR_SIZE=1 UFFD_LOG_DUMP=1 LD_PRELOAD=./$< ./test/t07
